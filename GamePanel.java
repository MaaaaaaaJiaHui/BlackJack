...
public class GamePanel extends JPanel implements ActionListener
{
    ...
    public JLabel playerWallet = new JLabel("$100");
    private JLabel cardsLeft = new JLabel("Cards left...");
    public static JLabel dealerSays = new JLabel("Dealer says...");
    ...
    public GamePanel(String name)
    {
        ...
        //player = new Player(name, 20, "Male");
        //player.setWallet(100.00);
		
        updateValues();
    }
    public void choose(String act){
    	server(act);//server("system:choose#"+act);
		showchoose(false);
    }
    ...
    public void showchoose(boolean show){
    	hitButton.setEnabled(show);
        doubleButton.setEnabled(show);
        standButton.setEnabled(show);
    }
    public void showchoose(boolean show,boolean musthit){
    	hitButton.setEnabled(show);
        doubleButton.setEnabled(show);
        if(musthit){
    ...
    public void updateValues()
    {
		...
		table.setName(dealer.getName(), player.getName());
        table.repaint();
